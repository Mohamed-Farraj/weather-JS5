...
function background(state) {
  switch (state) {
    case "rain":
      body.style.cssText = `
    background-image: url("/weather-JS5media/rain-bg.jpg");
    ...
    case "sunny":
      body.style.cssText = `
    background-image: url("/weather-JS5media/sunny-bg.jpg");
    background-position: center center;
    background-size: cover;
    ...
    case "storm":
      body.style.cssText = `
    background-image: url("/weather-JS5media/storm-bg.jpg");
    background-position: center center;
    background-size: cover;
        background-attachment:fixed;
    ...
    case "cold":
      body.style.cssText = `
    background-image: url("/weather-JS5media/cold-bg.jpg");
    background-position: center center;
    background-size: cover;
        background-attachment:fixed;
    ...
    case "cloud":
      body.style.cssText = `
    background-image: url("/weather-JS5media/cloud-bg.jpg");
    background-position: center center;
    background-size: cover;
        background-attachment:fixed;
    ...
    case "clear":
      body.style.cssText = `
    background-image: url("/weather-JS5media/clear-bg.jpg");
    background-position: center center;
    background-size: cover;
        background-attachment:fixed;
    ...
    case "fog":
      body.style.cssText = `
    background-image: url("/weather-JS5./weather-JS5media/fog-bg.jpg");
    background-position: center center;
    background-size: cover;
        background-attachment:fixed;
