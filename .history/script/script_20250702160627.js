    ...
    <div class="left w-50">
      <div class="row h-100 g-0">
        <div class="col-md-9">
          <div class="card-body h-100 d-flex flex-column justify-content-between pb-0">
            <div class="card-title d-flex justify-content-between">
              <small class="h6">${days[fDate.getDay()]}</small>
              <small class="h6">${fDate.getDate()} <small id="month">${months[fDate.getMonth() - 1]}</small></small>
            </div>
            <span class="card-text d-flex align-items-center justify-content-between">
              <h1 id="tempT">
            ...
            <p class="card-text">
              <small class="fs-5 text-nowrap" id="stateT">${stat}</small>
            </p>
          </div>
        </div>
        <div class="col-md-3 d-flex justify-content-center align-items-center">
          <img id="stateIconT" src="${futureIconSrc}" class="w-100 rounded-start" alt="Weather Icon" />
        </div>
      </div>
    </div>
      ...
      <div class="row justify-content-end g-0">
        <div class="col-md-12">
          <div class="card-body pb-0">
            ...
            <span class="card-text d-flex align-items-center justify-content-center">
              <div class="pie" style="--p:${data.forecast.forecastday[i + 1].day.daily_chance_of_rain}; --c:darkblue; --b:10px">
